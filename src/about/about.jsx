  ...
  return (
    <section className='about_section'>
      ...
      <p className='about_text'>
        My name is Mikhail. At the moment I am a specialized Front-end
        developer. This section presents my skills and expectations.
      </p>
      ...
      <p className='about_text'>
        I want to work as a front-end developer, it doesn't make much difference
        if I work remotely or in an office, I just like this path and I am happy
      ...
      <p className='about_text'>
        I am currently studying at the Minsk College of Entrepreneurship,
        specializing in Software of Information Technologies on the 3rd year. I
        speak Russian, Belarusian , English , I am also studying Polish.
      </p>
